...
CREATE PROCEDURE `saveUser` (IN `_network` VARCHAR(25), IN `_networkId` VARCHAR(25), IN `_username` VARCHAR(20), IN `_password` VARCHAR(40), IN `_email` VARCHAR(150), IN `_avatar` VARCHAR(255), IN `_suscribed` TINYINT(1))  BEGIN
  DECLARE error VARCHAR(255);
  DECLARE success VARCHAR(255);
